                    ...
                    <div className="flex flex-row mobile:flex-col items-center justify-center gap-[8.25rem] mobile:gap-[4.125rem] mt-[3.625rem]">
                        ...
                        >
                            <img
                                src={PurchaseImg}
                                alt=""
                                className={`h-[18.75rem] w-[18.75rem] mobile:h-[12.5rem] mobile:w-[12.5rem] rounded-full border-4 border-gray-600  hover:border-blue-400 duration-200 hover:cursor-pointer ${selectedType == "Compra" ? "border-blue-400" : ""
                                    }`}
                            />
                        ...
                        >
                            <img
                                src={BusinessImg}
                                alt=""
                                className={`h-[18.75rem] w-[18.75rem] mobile:h-[12.5rem] mobile:w-[12.5rem] rounded-full border-4 border-gray-600 hover:border-blue-400 duration-200 hover:cursor-pointer ${selectedType == "Venda" ? "border-blue-400" : ""
                                    }`}
                            />
                            <span className="font-inter text-3xl text-white uppercase">
                                Venda
