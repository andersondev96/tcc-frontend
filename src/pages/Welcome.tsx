        ...
        <div className="flex flex-row mobile:flex-col justify-between mobile:justify-start min-h-screen mobile:w-screen">
            ...
            <div className="flex flex-col align-center justify-center w-1/2 mobile:w-screen p-4 bg-blue-900">
                <div className="flex align-center justify-center mt-[1rem]">
                    <h1 className="font-montserrat font-medium text-[2.6rem] mobile:text-3xl text-white leading-tight text-center">
                        Faça um bom <br />
                        negócio <br />
                        e ajude um <br />
                        pequeno <br />
                ...
                <div className="flex flex-col items-center justify-center mt-6">
                    <span className="font-montserrat font-light text-sm text-white">
                        ou
                    </span>
                    <Link
                        to="/home"
                        className="font-montserrat font-light text-sm text-white cursor-pointer hover:underline"
                    >
                        Entre sem cadastrar
                    </Link>
                </div>
