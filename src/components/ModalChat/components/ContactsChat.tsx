...
interface ContactsChatProps {
    ...
    handleLoadingMessage: (connection: ConnectionsData) => void;
    userLogged: User;
}
export const ContactsChat: React.FC<ContactsChatProps> = ({ connections, handleLoadingMessage, userLogged }) => {
        ...
        <div className="flex flex-col mt-8">
            ...
            <ul className="flex flex-col mt-8">
                {connections && connections.map(connection => (
                    connection.user.email !== userLogged.email && (
                        <>
                            <li
                                ...
                                key={connection.id}
                                onClick={() => handleLoadingMessage(connection)}
                            >
