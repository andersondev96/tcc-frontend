...
export const Search: React.FC<SearchProps> = ({ onChange }) => {
    return (
        <div className="relative  w-64 sm:w-80">
            ...
            <input type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Pesquisar" required onChange={onChange} />
        </div>
    )
}