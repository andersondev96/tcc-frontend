            ...
            <div className="w-12 sm:w-60 h-full bg-gray-800 shadow-md fixed ">
                <div className="flex flex-col flex-1 items-center mt-8 justify-center sm:items-stretch sm:justify-start">
                    <div className="hidden sm:flex ml-6 flex-shrink-0 items-center">
                        <a href="/admin" className="block h-8 w-auto lg:block font-cursive font-medium text-xl text-gray-200">
                            Start Business
                        </a>
                    </div>
                    ...
                    <div className="mt-6 bg-blue-900 hover:bg-blue-800 transition duration-300">
                        <div className="flex space-x-4 sm:ml-6">
                            <a href="/admin/business" className="flex flex-row text-white px-3 py-2 rounded-md font-medium">
                    ...
                    <div className="mt-1.5 hover:bg-blue-800 transition duration-300">
                        <div className="flex space-x-4 sm:ml-6">
                            <a href="/admin/services" className="flex flex-row text-white px-3 py-2 rounded-md font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className="mt-1.5 hover:bg-blue-800 transition duration-300">
                        <div className="flex space-x-4 sm:ml-6">
                            <a href="/admin/clients" className="flex flex-row text-white px-3 py-2 rounded-md font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className="mt-1.5 hover:bg-blue-800 transition duration-300">
                        <div className="flex space-x-4 sm:ml-6">
                            <a href="/admin/budget" className="flex flex-row text-white px-3 py-2 rounded-md font-medium">
                    ...
                    <div className="mt-1.5 hover:bg-blue-800 transition duration-300">
                        <div className="flex space-x-4 sm:ml-6">
                            <a href="/admin/chat" className="flex flex-row text-white px-3 py-2 rounded-md font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className="mt-1.5 hover:bg-blue-800 transition duration-300">
                        <div className="flex space-x-4 sm:ml-6">
                            <a href="/admin/settings" className="flex flex-row text-white px-3 py-2 rounded-md font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
